...
<div class="container-fluid">
	<div class="row" style="background-color:#39D8D8">
		...
		<div class="row" style="margin-left:20px;margin-right:20px;height:750px">
		...
		<!-- return -->
			<div class="row">
				<form class="form-horizontal" role="form" action="${pageContext.request.contextPath }/newmanage/return">
