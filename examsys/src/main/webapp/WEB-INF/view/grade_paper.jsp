...
<div class="container-fluid">
	<div class="row" style="background-color:#39D8D8">
		...
		<div class="col-md-8" style="background-color:#f5f5f5;margin-top:80px">
			...
			<div class="row">
				<form class="form-horizontal" role="form" action="${pageContext.request.contextPath }/manage/submitscore">
			...
			<br><br>
			<div class="row">
				<form class="form-horizontal" role="form" action="${pageContext.request.contextPath }/manage">
